...
#### Salamander habitat preference in old growth vs clear-cut forest sections
...
There is not a significant effect of forest condition (old growth or clear-cut) on where in the channel salamanders are found ($\chi$^2^(`r chi_count_result$parameter`) = `r chi_count_result$statistic`). There are similar proportions of salamanders found in each of the three channel classifications (cascades, pools, and side-channels) in both the clear-cut and old growth sections of forest (Table 1).



#### Comparison of Salamander weight in old growth vs clear-cut forest sections
...
# Data are not not totally normally distributed - mostly normal except for at very high weights. Since the majority seem normal, will still do a two-sample t-test.
weight_t <- t.test(weight_og$weight, weight_cc$weight)
weight_t

# Mann-whitney u for non-parametric data just out of curiosity
...
#### Comparison of Salamander weight by habitat type
